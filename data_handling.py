...
DEFAULT_REVIEWS_FILE = "input_data/yelp_academic_dataset_review.json"
DEFAULT_BUSINESS_FILE = "input_data/yelp_academic_dataset_business.json"
DEFAULT_REVIEWS_PICKLE = "pickles/reviews.pickle"
